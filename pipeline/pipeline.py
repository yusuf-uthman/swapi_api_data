...
def extract_insert(schema, table):
    ...
    for rec in api_data_list:
        cursor.execute(f""" 
              insert into {schema}.{table}(name, height, mass, hair_color, skin_color, eye_color, birth_year, gender, homeworld,
              films, species, vehicles, starships, created, edited, url) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)""", rec)
        conn.commit()
